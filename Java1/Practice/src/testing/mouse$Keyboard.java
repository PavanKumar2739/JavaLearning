...
public class mouse$Keyboard {
    ...
    public void test() throws Exception{
		...
		//act.keyDown(name,Keys.SHIFT).build().perform();
		 WebElement ac1=driver.findElement(By.xpath("//div[@class='navbar-collapse collapse navbar-right']/ul/li[6]/a"));
		 WebElement Child_ac2=driver.findElement(By.xpath("//div[@class='navbar-collapse collapse navbar-right']/ul/li[6]/ul/li[1]/a"));
		 WebElement Child_click1=driver.findElement(By.xpath("//div[@class='navbar-collapse collapse navbar-right']/ul/li[6]//li[1]//li[2]"));

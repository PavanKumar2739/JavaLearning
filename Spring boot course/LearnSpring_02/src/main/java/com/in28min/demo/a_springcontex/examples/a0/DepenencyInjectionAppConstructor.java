...
public class DepenencyInjectionAppConstructor {
	...
	class YourbusinessClass{
		...
		//@Autowired// no need autowired here because of spring can manage internaly.
		//spring documentation recomened to use the constructor based injection
	...
	public static void main(String[] args) {
		...
		try(var context = new AnnotationConfigApplicationContext(DepenencyInjectionAppConstructor.class)){

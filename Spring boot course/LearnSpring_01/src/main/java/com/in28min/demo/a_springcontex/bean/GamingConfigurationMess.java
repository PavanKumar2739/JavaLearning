...
@Configuration
@ComponentScan("com.in28min.demo.looslycoupledgame.beans")
public class GamingConfigurationMess {
...
//	
	@Bean(name="game2")
	@Qualifier("GamingConsoleQulify1")
	public GamingConsole game2() {//taken from loosly coupled

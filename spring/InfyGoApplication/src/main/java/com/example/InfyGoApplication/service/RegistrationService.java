package com.example.InfyGoApplication.service;
...
import com.example.InfyGoApplication.exception.InfyGoBootException;
import com.example.InfyGoApplication.exception.InvalidCityException;
import com.example.InfyGoApplication.exception.InvalidEmailException;
import com.example.InfyGoApplication.exception.InvalidNameException;
import com.example.InfyGoApplication.exception.InvalidPasswordException;
import com.example.InfyGoApplication.exception.InvalidPhoneException;
import com.example.InfyGoApplication.exception.InvalidUserIdException;
import com.example.InfyGoApplication.exception.UserIdAlreadyPresentException;
import com.example.InfyGoApplication.repository.UserRepository;
...
public class RegistrationService {
	...
	public String registerUser(UserDto user) throws InfyGoBootException{
		validateUser(user);
	...
	public void validateUser(UserDto user) throws InfyGoBootException {
